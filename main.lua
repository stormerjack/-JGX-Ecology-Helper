        ...
        groups = {
            {
                ...
                entries = {
                    ...
                    "Spotted Deer", "Female Elk", "Young Elk", "Elk", "Baby Waragon", "Waragon", "Farm Boar",
                    "Locust Swarm", "Plantation Big Mole", "Plantation Small Mole", "Bat", "Young Stone Rat", "Mountain Lamb",
                    "Brown Raccoon", "Blue Lizard", "Calpheon Beetle", "Young Red Boar", "Calpheon Worm", "Rhino Lizard",
                    "Stone Rat", "Red Boar", "Iguana", "Stone Crab", "Big House-Parasitic Bee", "Rainbow Fox",
                    "Stonescale Devourer", "Spotted Hyena", "Red Boar's Den", "Red Bear", "Ferocious Weasel",
                    "Long-haired Water Buffalo", "Explosive Waragon", "Waragon Egg", "Kuku Hatchling"
                }
            },
            {
                title = "Plants",
                entries = {
                    "Toxic Cave Plant", "Treant Crystal Tree", "Lazy Tree Spirit", "Tough Tree Spirit", "Small Treant",
                    "Treant Spirit", "Scream Treant", "Treant Stub", "Rooted Old Wood Treant", "Twin-Headed Treant",
                    "Owl Treant", "Root Treant", "Old Tree Treant"
                }
            },
            {
                title = "Khurutos",
